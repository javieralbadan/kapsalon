...
const EditAvailability = () => {
  ...
  //   const [availsList, setAvailsList] = useState<StaffAvailabilityRow[] | []>([]);
  ...
  //     const newAvailabilities = availsList.filter(({ id }) => id !== removeId);
  //     console.log({ newAvailabilities });
  //     setAvailsList(newAvailabilities);
