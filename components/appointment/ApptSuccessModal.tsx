...
const ApptSuccessModal = ({ showSuccessModal, barberName, serviceName, dateTime }: Props) => {
  return (
    <Modal open={showSuccessModal} footer={null} closable={false} width={550} destroyOnClose>
...
export default ApptSuccessModal;
